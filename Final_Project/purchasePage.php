...
if(isset($_GET["shoppingCartButton"])) {
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "[<a href='add_to_cart.php?name=" . $row['video_game_name'] . "&location=purchasePage'> Add to cart </a>]</td></tr>"; 
    }
}
echo "</table>";
}
...
<html>
    <head>
        ...
        <h1 id="vgames">Purchase Video Games</h1>
    </head>
    <body>
        <form id="vgames">
            ...
            <fieldset id="submitButton">
                ...
                <input type="submit" id="back" name="backButton" value="Log out" />
                <input type="submit" id="shoppingCart" name="shoppingCartButton" value="Shopping Cart" />
            </fieldset>
        </form>
        <?php 
            search();
